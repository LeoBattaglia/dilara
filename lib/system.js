...
exports.writeFile = exports.setContentType = exports.isProjectPageExist = exports.isProjectNameExist = exports.isNull = exports.getProjectIndex = exports.fillString = exports.deleteFolder = exports.createFolder = exports.copyFile = exports.capitalize = void 0;
//Imports
...
function copyFile(src, dst) {
    ...
    if (interface_1.fs.existsSync(p_src)) {
        ...
        interface_1.fs.copyFile(p_src, p_dst, function (err) {
            if (err) {
...
exports.isProjectPageExist = isProjectPageExist;
function setContentType(pathString, res) {
