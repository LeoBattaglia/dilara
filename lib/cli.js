...
function copyProjectFiles(path) {
    interface_1.sys.createFolder(path);
    interface_1.sys.createFolder(path + "/modules");
    interface_1.sys.createFolder(path + "/modules/index");
    interface_1.sys.copyFile("./lib/default/global.css", path + "/global.css");
    //sys.copyFile("./lib/default/favicon.ico", path + "/favicon.ico");
    interface_1.sys.copyFile("./lib/default/index.html", path + "/modules/index/index.html");
    interface_1.sys.copyFile("./lib/default/index.css", path + "/modules/index/index.css");
    interface_1.sys.copyFile("./lib/default/index.ts", path + "/modules/index/index.ts");
    interface_1.sys.copyFile("./lib/default/icon.png", path + "/modules/index/icon.png");
}
            ...
            switch (_b.label) {
                case 0:
                    ...
                    switch (_a) {
                        ...
                        case interface_1.config.cmd_cli.input: return [3 /*break*/, 11];
                        case interface_1.config.cmd_cli.start: return [3 /*break*/, 12];
                    }
                    return [3 /*break*/, 13];
                ...
                case 8:
                    ...
                    return [3 /*break*/, 14];
                case 9:
                    process.send(interface_1.config.cmd.sessions);
                    //input().then();
                    return [3 /*break*/, 14];
                case 10:
                    printProjects();
