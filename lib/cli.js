        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, interface_1.pp.select("Select Project:", getProjectNames())];
                case 3:
                    project = _a.sent();
                    _a.label = 4;
                case 4:
                ...
                case 1:
                    ...
                    if (interface_1.sys.isNull(name) || name.length < 4) {
                        ...
                        if (interface_1.sys.isProjectNameExist(name)) {
                            ...
                            interface_1.sys.writeFile("./lib/projects.json", JSON.stringify(interface_1.projects));
            ...
            switch (_b.label) {
                case 0:
                    ...
                    switch (_a) {
                        ...
                        case interface_1.config.cmd.show: return [3 /*break*/, 9];
                        case interface_1.config.cmd_cli.start: return [3 /*break*/, 10];
                    }
                    return [3 /*break*/, 11];
