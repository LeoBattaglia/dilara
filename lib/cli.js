...
function deleteProject() {
    return __awaiter(this, void 0, void 0, function () {
        var options, _i, _a, project, select, choose, index;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    options = [];
                    for (_i = 0, _a = projects.projects; _i < _a.length; _i++) {
                        project = _a[_i];
                        options.push(project.name);
                    }
                    return [4 /*yield*/, pp.select("Select Project:", options)];
                case 1:
                    select = _b.sent();
                    pp.printLine();
                    return [4 /*yield*/, pp.choose("Do you really want to delete '" + select.toString() + "'?", "y", "n", "YES", "NO", false)];
                case 2:
                    choose = _b.sent();
                    if (!choose) return [3 /*break*/, 4];
                    index = sys.getProjectIndex(select.toString(), projects.projects);
                    if (index > -1) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = cmd;
                    switch (_a) {
                        case config.cmd.delete: return [3 /*break*/, 1];
                        case config.cmd.exit: return [3 /*break*/, 3];
                        case config.cmd.new: return [3 /*break*/, 4];
                        case config.cmd_cli.start: return [3 /*break*/, 6];
                    }
                    return [3 /*break*/, 7];
                case 1: return [4 /*yield*/, deleteProject()];
                case 2:
                    _b.sent();
                    return [3 /*break*/, 9];
                case 3:
                    ...
                    return [3 /*break*/, 9];
                case 4: return [4 /*yield*/, createProject()];
                case 5:
                    _b.sent();
                    return [3 /*break*/, 9];
                case 6:
